...
export const ROLE_DISTRIBUTIONS: { [playerCount: number]: RoleDistribution } = {
  3: { '人狼': 1, '占い師': 1, '怪盗': 1, '市民': 2 },  // 5枚: 3人 + 場札2枚
  4: { '人狼': 1, '占い師': 1, '怪盗': 1, '市民': 3 },  // 6枚: 4人 + 場札2枚
  5: { '人狼': 2, '占い師': 1, '怪盗': 1, '市民': 3 },  // 7枚: 5人 + 場札2枚
  6: { '人狼': 2, '占い師': 1, '怪盗': 1, '市民': 4 },  // 8枚: 6人 + 場札2枚
  7: { '人狼': 2, '占い師': 1, '怪盗': 1, '市民': 5 },  // 9枚: 7人 + 場札2枚
  8: { '人狼': 2, '占い師': 1, '怪盗': 1, '市民': 6 },  // 10枚: 8人 + 場札2枚
};
...
export function getRoleDescription(role: Role): {
  ...
  if (role === '人狼') {
    ...
    return {
      team: '市民チーム',
      winCondition: '交換後の役職に応じて変わります。',
      ability: '今晩、1人を選び、その人と役職を交換できます。交換後の役職が通知されます。交換後はその役職の勝利条件になります。',
    };
  } else {
    // 市民
    return {
